(function () {
    ...
    var stageDom = document.getElementById((window._mrmcp || {})['script_id'] || "Mugeda_5ede34942ce5c1548d789d4e")

    _mrmcp = (typeof _mrmcp == 'undefined') ? {} : _mrmcp;
_mrmcp['campaign_id'] = 'none';
_mrmcp['owner_id'] = '5d6b6a4ecec589741d5cfc7b';
_mrmcp['creative_id'] = '5ede34942ce5c1548d789d4e';
...
_mrmcp['type'] = 'smart';
_mrmcp['title'] = '小米设计生态研究';
_mrmcp['build_number'] = parseInt('355');
_mrmcp['publish_time'] = 'Tue Jun 09 2020 15:31:40 GMT+0800 (CST)';
_mrmcp['last_modified'] = '';
_mrmcp['jsapi_config_url'] = '';
_mrmcp['track_bot'] = 'http://cd.mugeda.com/media/pages/track/track_20131030.html';
var version = _mrmcp['version'] = _mrmcp['version'] != null ? _mrmcp['version'] : '0.3.55';
...
window['Mugeda']['Loader'] = function (dom, hasScript, _mrmcp) {
    ...
    if(!Mugeda['css3PlayerLoaded']) {
        ...
        loadRes(1, jsPath + that.crid + ".js?publishTime=1591687900085", [], undefined, function(callback){
            var chk = function(){
...
Mugeda.Loader.prototype.start = function () {
    if (2 == Mugeda.css3PlayerLoaded) {
        ...
        Mugeda['startAnimation']("id_" + this.crid, false ? "actions_" + this.crid + ".js?publishTime=1591687900085" : "", a, this.resDir, this.name, null, this._mrmcp)
    }
    else {
